...
namespace PalmyraOS::kernel {
     ...
     */
    typedef void (
            *PageFaultHandler)(interrupts::CPURegisters* regs, uint32_t faultingAddress, bool isPresent, bool isWrite, bool isUserMode, bool instructionFetch);
    ...
    inline PageFlags operator|(PageFlags lhs, PageFlags rhs) { return static_cast<PageFlags>(static_cast<uint32_t>(lhs) | static_cast<uint32_t>(rhs)); }
    ...
    public:
         ...
         */
        [[nodiscard]] inline uint32_t getNumAllocatedPages() const { return pagesCount_; };
