...
namespace PalmyraOS::kernel::GDT {
    ...
    class SegmentDescriptor {  // Base address bits 24-31
    public:
        ...
        [[nodiscard]] inline uint32_t getBase() const { return (addr_24_31 << 24) | (addr_16_23 << 16) | addr_0_15; }

        // Inline function to retrieve full 32-bit limit
        [[nodiscard]] inline uint32_t getLimit() const { return (flag_size_16_19 & 0xF) << 16 | size_0_15; }
