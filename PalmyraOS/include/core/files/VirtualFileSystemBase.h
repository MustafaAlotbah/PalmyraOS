...
namespace PalmyraOS::kernel::vfs {
    ...
    public:
         ...
         */
        enum class UserID : uint32_t { ROOT = 0, USER = 1000 };

        /**
         * @enum GroupID
         * @brief Enum class for group IDs.
         */
        enum class GroupID : uint32_t { ROOT = 0, GROUP = 1000 };
    ...
    public:
         ...
         */
        virtual InodeBase* allocateInode(InodeBase::Type type, InodeBase::Mode mode, InodeBase::UserID userId, InodeBase::GroupID groupId);
