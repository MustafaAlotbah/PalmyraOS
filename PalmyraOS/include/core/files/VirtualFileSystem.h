...
namespace PalmyraOS::kernel::vfs {
    ...
    public:
         ...
         */
        explicit FunctionInode(ReadFunction readFunc = nullptr, WriteFunction writeFunc = nullptr, IOCTLFunction ioctlFunc = nullptr);
    ...
    public:
         ...
         */
        static InodeBase* createDirectory(const KString& path,
                                          InodeBase::Mode mode,
