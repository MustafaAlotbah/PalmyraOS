...
namespace PalmyraOS::kernel::interrupts {
    ...
    enum class GateType { TaskGate = 0b0101, InterruptGate = 0b1110, TrapGate = 0b1111 };
    ...
    public:
        ...
        void setDescriptor(uint8_t interruptVector, uint16_t codeSegmentSelector, void (*handlerFunc)(), uint8_t privilegeRing, GateType gateType);
    ...
    public:
        ...
        inline ports::BytePort& getMasterPicCommand() { return masterPicCommand; };
        inline ports::BytePort& getSlavePicCommand() { return slavePicCommand; };
        inline ports::BytePort& getMasterPicData() { return masterPicData; };
        inline ports::BytePort& getSlavePicData() { return slavePicData; };
