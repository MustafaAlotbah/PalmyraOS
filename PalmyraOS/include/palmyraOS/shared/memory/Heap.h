...
namespace PalmyraOS::types {
    ...
    public:
         ...
         */
        [[nodiscard]] inline uint32_t getTotalAllocatedMemory() const { return totalAllocatedMemory_; }

        /**
         * @brief Returns the total free memory.
         * @return uint32_t Total free memory in bytes.
         */
        [[nodiscard]] inline uint32_t getTotalFreeMemory() const { return totalMemory_ - totalAllocatedMemory_; }

        /**
         * @brief Returns the total memory.
         * @return uint32_t Total memory in bytes.
         */
        [[nodiscard]] inline uint32_t getTotalMemory() const { return totalAllocatedMemory_; }
