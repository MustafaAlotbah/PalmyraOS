...
namespace PalmyraOS::SDK {
    ...
    public:
        ...
        [[nodiscard]] inline uint32_t getY() const { return prevPositionY_ + currCursorY_ + 1; }
        [[nodiscard]] inline uint32_t getWidth() const { return currWidth_ - 2; }
        [[nodiscard]] inline uint32_t getHeight() const { return currHeight_ - 2; }
