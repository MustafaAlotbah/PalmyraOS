...
void PalmyraOS::Tests::Allocator::ExceptionTester::setup() { kernel::runtime::setOutOfRangeHandler(RuntimeHandler); }
void PalmyraOS::Tests::Allocator::ExceptionTester::reset() {
    exceptionOccurred_ = false;
    kernel::runtime::setOutOfRangeHandler(nullptr);
}

void PalmyraOS::Tests::Allocator::ExceptionTester::RuntimeHandler(const char* message) { exceptionOccurred_ = true; }
