...
PalmyraOS::kernel::vfs::MasterBootRecord::MasterBootRecord(const uint8_t* masterSector) : isValid_(false) {
...
bool PalmyraOS::kernel::vfs::MasterBootRecord::isValid() const { return isValid_; }

PalmyraOS::kernel::vfs::MasterBootRecord::PartitionType PalmyraOS::kernel::vfs::MasterBootRecord::castToPartitionType(uint8_t value) {
    switch (value) {
        case FAT16:
        case FAT16_LBA:
        case FAT32:
        case FAT32_LBA:
        case NTFS: return static_cast<PartitionType>(value);
